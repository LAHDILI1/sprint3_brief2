                            ...
                            <div class="card flex-fill border-0 illustration">
                                <div class="card-body p-0 d-flex flex-fill">
                                    <div class="row g-0 w-100">
                                        <div class="col-6">
                                            <div class="p-3 m-1">
                                                <h4>Welcome Back, <?php if(!empty($_SESSION["first_name"])) echo $_SESSION["first_name"] . ' ' . $_SESSION["last_name"];?> </h4>
    ...
    <form action="../../App/Controllers/admin/add.php" method="POST" me id="bookForm">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
            ...
            <footer class="footer">
                        <div class="container">
                            <span class="text-muted">Copyright &copy; 2023 Your Company. All rights reserved.</span>
                       </div>
